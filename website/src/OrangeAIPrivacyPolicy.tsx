...
export default function OrangeAIPrivacyPolicy() {
  return (
    <div className="min-h-screen bg-black text-white transition-colors duration-300 selection:bg-lime-400 selection:text-black">
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-black/90 backdrop-blur-xl px-4 py-2.5">
        <div className="max-w-3xl mx-auto flex items-center gap-4">
          ...
          <span className="text-sm font-bold opacity-40">Orange AI</span>
        </div>
      </nav>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-sm opacity-50 font-medium mb-10">Orange AI · Last updated February 2026</p>
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-8 text-white/80 font-medium leading-relaxed">
          <section>
            ...
            <p>
              Orange AI (“we,” “our,” or “the app”) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard information when you use our application.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To provide our AI assistant features, Orange AI may process the following types of input you provide:
            </p>
          ...
          <section>
            ...
            <p>
              We may update this Privacy Policy from time to time. We will notify you of material changes through the app or by other reasonable means. Continued use of Orange AI after changes constitutes acceptance of the updated policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              For privacy-related questions or requests, please contact us through the support or contact options provided in the Orange AI app or on our website.
            </p>
          </section>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          ...
          >
            <ChevronLeft className="w-4 h-4" /> Back to Orange AI
          </Link>
        </div>
      </main>
    </div>
