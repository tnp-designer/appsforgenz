...
export const MOCK_APPS: AppData[] = [
  ...
  },
  {
    ...
    age: '26d',
    txns: '1.72K',
    description: 'Mike AI is an AI search engine and contract drafting assistant built for fast research, clause generation, document refinement, and legal workflow support.',
    releaseDate: '01 Apr 2026',
    tags: ['AI Search', 'Contracts', 'Legal Tech'],
    iconUrl: 'https://picsum.photos/seed/mikeai/200/200',
    screenshots: [
      'https://picsum.photos/seed/mikeai1/400/800',
      'https://picsum.photos/seed/mikeai2/400/800',
      'https://picsum.photos/seed/mikeai3/400/800',
    ],
    status: 'Active',
    subtitle: 'AI-powered search and contract drafting for faster legal and business workflows.',
    privacyPolicyPath: '/mike-ai/privacy-policy',
    openAppLabel: 'Open Mike AI',
  },
];
